<div class="content">PHP 주석 — 2021년 10월 
===================

<div class="post-info">![로만 프론스키](https://secure.gravatar.com/avatar/269798998e24876e4f3ea6f6d1effdc7?s=200&r=g)<div class="post-info__text"> [로만 프론스키](https://blog.jetbrains.com/author/rpronskiy) <time class="publish-date" data-day="14" data-month="10" data-year="2021" datetime="2021-10-14"></time></div></div><div class="ez-toc-v2_0_17 counter-hierarchy ez-toc-transparent" id="ez-toc-container"><div class="ez-toc-title-container"> 목차
...
</nav></div> [![PHP 주석 월간](https://blog.jetbrains.com/wp-content/uploads/2020/01/phpstorm-PHP_Annotated_blog_1600x800.png)](https://blog.jetbrains.com/phpstorm/2021/10/php-annotated-october-2021/)
...
- ### <span class="ez-toc-section" id="PHP_81_RC_3"></span> PHP 8.1 RC 3<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="PHP_8011_7424_and_7331"></span> [PHP 8.0.11](https://www.php.net/ChangeLog-8.php#8.0.11) , [7.4.24](https://www.php.net/ChangeLog-7.php#7.4.24) 및 [7.3.31](https://www.php.net/ChangeLog-7.php#7.3.31)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="The_Future_of_Magento"></span> [마젠토의 미래](https://www.mage-os.community/blog/the-future-of-magento)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="PhpStorm_20213_Early_Access_Program_Is_Open"></span>[PhpStorm 2021.3 얼리 액세스 프로그램 오픈](https://blog.jetbrains.com/phpstorm/2021/09/phpstorm-2021-3-early-access-program-is-open/)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="PER_Workflow_-_PHP-FIG"></span> [PER 워크플로 – PHP-FIG](https://www.php-fig.org/bylaws/per-workflow/)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="Vulnerability_not_in_PHP_to_bypass_disable_functions"></span> `disable_functions` 를 우회하는 PHP의 "취약점"(not)<span class="ez-toc-section-end"></span>
    ...
    <iframe height="557" id="reddit-embed" loading="lazy" sandbox="allow-scripts allow-same-origin allow-popups" scrolling="no" src="https://www.redditmedia.com/r/PHP/comments/q2cvkb/yet_another_php_7080_disable_functions_bypass/hflmnfc/?depth=1&showmore=false&embed=true&showmedia=false" style="border: none;" width="640"></iframe>  
...
- ### <span class="ez-toc-section" id="composercomposer_219"></span> [작곡가/작곡가 2.1.9](https://github.com/composer/composer/releases/tag/2.1.9)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="PHPOpenDocscom"></span> [PHPOpenDocs.com](https://phpopendocs.com/about)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="New_data_structures_in_PHP"></span> PHP의 새로운 데이터 구조<span class="ez-toc-section-end"></span>
    ...
    - [**\[RFC\] 최종 클래스 벡터**](https://wiki.php.net/rfc/vector) 벡터 구조 – 연속된 인덱스 0, 1, 2 등을 가진 요소 집합입니다. 현재 배열보다 절반의 메모리가 필요하고 유사한 SPL 구조보다 빠르게 작동합니다. API 측면에서 보면 그냥 의 구현이 있는 일반적인 클래스  
        ...
        ```
        <pre class="EnlighterJSRAW" data-enlighter-language="php" data-enlighter-linenumbers="false" data-enlighter-title=""> $values = 새로운 Vector();
        ($i = 0; $i에 대해
        ```
...
- ### <span class="ez-toc-section" id="RFC_Allow_null_as_standalone_type"></span> [\[RFC\] null을 독립형 유형으로 허용](https://wiki.php.net/rfc/null-standalone-type)<span class="ez-toc-section-end"></span>
...
- ### <span class="ez-toc-section" id="How_opcache_works"></span> [opcache 작동 방식](https://www.npopov.com/2021/10/13/How-opcache-works.html)<span class="ez-toc-section-end"></span>
...
<div class="content__row"><div class="tag-list"> [Laravel](/phpstorm/tag/laravel/) [Magento](/phpstorm/tag/magento/) [PHP](/phpstorm/tag/php/) [PHP 8.1](/phpstorm/tag/php-8-1/) [PHP 8.2](/phpstorm/tag/php-8-2/) [PHP Annotated Monthly](/phpstorm/tag/php-annotated-monthly/) [psr](/phpstorm/tag/psr/) [RFC](/phpstorm/tag/rfc/) [symfony](/phpstorm/tag/symfony/)</div>- <span>공유하다</span>
...
</div><div class="content__pagination"> [PhpStorm 2021.3 앞서 해보기 빌드 #3](https://blog.jetbrains.com/phpstorm/2021/10/phpstorm-2021-3-eap-3/) [PhpStorm 2021.3 EAP 빌드 #4](https://blog.jetbrains.com/phpstorm/2021/10/phpstorm-2021-1-eap-4-2/)</div></div><div class="container comments-container"><div class="content"><div id="remark42"></div></div></div>