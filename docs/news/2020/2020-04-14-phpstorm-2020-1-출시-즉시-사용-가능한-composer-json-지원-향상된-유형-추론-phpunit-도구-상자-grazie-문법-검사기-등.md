[소식](/phpstorm/category/news/) PhpStorm 2020.1 출시: 즉시 사용 가능한 composer.json 지원, 향상된 유형 추론, PHPUnit 도구 상자, Grazie 문법 검사기 등 
===========================================================================================
 ...
 **PhpStorm 2020.1이 출시되었습니다!**
 ...
 [PhpStorm 2020.1 다운로드](https://www.jetbrains.com/phpstorm/whatsnew/)
