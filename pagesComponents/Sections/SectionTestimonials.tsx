      ...
      <div className="items-center flex flex-wrap mt-10">
        <div className="w-full md:w-1/2 lg:w-1/3 md:px-4">
          <TestimonialCard name="Nick Willever" date="1 day ago">
            &quot;This is an excellent product, the documentation is excellent and helped me get
            things done more efficiently.&quot;
          </TestimonialCard>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/3 md:px-4">
          <TestimonialCard color="blue" name="Shailesh Kushwaha" date="1 week ago">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 md:px-4">
          <TestimonialCard name="Samuel Kamuli" date="3 weeks ago">
            &quot;Great product. Helped me cut the time to set up a site. I used the components
            within instead of starting from scratch. I highly recommend for developers who want to
            spend more time on the backend!.&quot;
          </TestimonialCard>
        </div>
        <div className="items-center flex mt-16 lg:mx-auto">
          <div className="w-full md:w-1/5 px-12 md:px-4 mr-8">
            <img className="w-auto" src="/img/logos/logo-amazon.webp" alt="tailwind_logo_amazon" />
          </div>
          <div className="w-full md:w-1/5 px-12 md:px-4 mr-8">
            <img className="w-auto" src="/img/logos/logo-ibm.webp" alt="tailwind_logo_ibm" />
          </div>
          <div className="w-full md:w-1/5 px-12 md:px-4 mr-8">
            <img
              className="w-auto"
          ...
          <div className="w-full md:w-1/5 px-12 md:px-4 mr-8">
            <img className="w-auto" src="/img/logos/logo-cisco.webp" alt="tailwind_logo_cisco" />
          </div>
