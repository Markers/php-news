...
navigation: ["card blog", "card basic", "card image inside", "card signin", "card horizontal"]
---
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <p className="mb-4 opcacity-60">
          ...
          great. For being a bright color. For standing out.
        </p>
      ...
      <div className="flex">
        ...
        <div className="w-2/3 card-body">
          ...
          <p className="opacity-80 mb-5">
            ...
            model disruption is only part of the story — and <a href="#">Read More</a>.
          </p>
          <p>
  ...
  <div class="flex">
    ...
    <div class="w-2/3 card-body">
      ...
      <p class="opacity-80 mb-5">
        ...
        disruption is only part of the story — and{" "} <a href="#">Read More</a>.
      </p>
