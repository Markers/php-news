...
<ComponentCard id="checkbox">
  <label className="inline-flex items-center mt-3">
    <input type="checkbox" className="checkbox opacity-0 cursor-pointer absolute z-10" />
...
<label class="inline-flex items-center mt-3">
  <input type="checkbox" class="checkbox opacity-0 cursor-pointer absolute z-10" />
